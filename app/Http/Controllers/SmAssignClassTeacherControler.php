...
class SmAssignClassTeacherControler extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            return redirect()->back()->with('message-success', 'Class Teacher has been Assigned successfully');
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            ...
            return redirect()->back()->with('message-success', 'Class Teacher has been updated successfully');
