...
class SmExamRoutineController extends Controller
{
    ...
    public function examScheduleReportSearch(Request $request){
        ...
        return view('backEnd.examination.exam_schedule', compact('classes', 'exams', 'assign_subjects', 'class_id', 'section_id', 'exam_id', 'exam_schedule_subjects', 'assign_subject_check','exam_types', 'exam_periods'));
    }
