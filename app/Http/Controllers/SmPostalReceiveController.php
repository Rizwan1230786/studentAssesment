...
class SmPostalReceiveController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(ApiBaseMethod::checkUrl($request->fullUrl())){
            ...
            if($result){
                return redirect()->back()->with('message-success', 'Postal has been created successfully');
            }else{
    ...
    public function update(Request $request)
    {
        ...
        if(ApiBaseMethod::checkUrl($request->fullUrl())){
            ...
            if($result){
                return redirect('postal-receive')->with('message-success', 'Postal has been updated successfully');
            }else{
                return redirect()->back()->with('message-danger', 'Something went wrong, please try again');
            }
        }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        if(ApiBaseMethod::checkUrl($request->fullUrl())){
            ...
            if($result){
                return redirect('postal-receive')->with('message-success', 'Postal has been deleted successfully');
            }else{
                return redirect()->back()->with('message-danger', 'Something went wrong, please try again');
            }
        }
