...
class SmStudentAdmissionController extends Controller
{
               ...
               try{
                   ...
                   try{
                       ...
                       // $student->driver_phone_no = $request->driver_phone;
                        ...
                        return redirect('student-list')->with('message-success', 'Student has been created successfully');
                    }  catch (\Exception $e) {
                        DB::rollback();
    ...
    public function studentView(Request $request, $id){
        ...
        return view('backEnd.studentInformation.student_view', compact('student_detail', 'fees_assigneds', 'fees_discounts', 'exams', 'documents', 'timelines', 'siblings', 'grades'));
    }
                   ...
                   $student_user->save();
                    ...
                    try{
                       ...
                       if(count($siblings) == 1){
                        ...
                        return redirect()->back()->with('message-success', 'Student has been deleted successfully');
                    } catch (\Exception $e) {
                        DB::rollback();
            ...
            try{
                ...
                try{
                    ...
                    try{
                        ...
                        return redirect('student-list')->with('message-success', 'Student has been updated successfully');
    ...
    public function studentCurrentSearch(Request $request){
        ...
        if($students->isEmpty()){
            return redirect('student-promote')->with('message-danger', 'No result found');
        }
    ...
    public function studentPromoteStore(Request $request){
        ...
        if($request->promote_class == "" || $request->promote_session == ""){
            ...
            try{
                ...
                return redirect('student-promote')->with('message-success', 'Student has been promoted successfully');
                ...
                return view('backEnd.studentInformation.student_promote', compact('sessions', 'classes', 'students', 'current_session', 'current_class'))->with('message-danger', 'Something went wrong, please try again');
            }
    ...
    public function downloadStudentFile(){
        ...
        $studentsArray = ['session', 'roll_no','first_name','last_name','date_of_birth','religion', 'gender','caste','mobile','email','admission_date','blood_group','height','weight','father_name','father_phone','father_occupation','mother_name','mother_phone','mother_occupation','guardian_name','guardian_relation','guardian_email','guardian_phone','guardian_occupation','guardian_address','current_address','permanent_address','bank_account_no','bank_name','national_identification_no','local_identification_no','previous_school_details','note'];
        ...
        if($data->count()){
            ...
            foreach ($data as $key => $value) {
                ...
                try{
                    ...
                    $user_stu->username = $short_form.'-'.$max_admission_id;
                    if(empty($value->email)){
                        $user_stu->email =$short_form.'-'.$max_admission_id;
                    }else{
                    ...
                    try{
                        ...
                        if($value->sibling_id == ""){
                            ...
                            $user_parent->username = 'par-'.$max_admission_id;
                            if($value->guardian_email != ""){
                                $user_parent->email = $value->guardian_email;
                            }else{
                                $user_parent->email = 'par-'.$max_admission_id;
                            }
            ...
            return redirect()->back()->with('message-success', 'Bulk student has been created successfully');
        }
