                    ...
                    <div class="white-box radius-t-y-0 student-details">
                        ...
                        <div class="single-meta">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="value">
                                    {{date('jS M, Y', strtotime($admission_query->date))}}
                                </div>
                            </div>
                        </div>
                        <div class="single-meta">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="value">
                                     {{$admission_query->last_follow_up_date != ""? date('jS M, Y', strtotime($admission_query->date)):''}}
                                </div>
                            </div>
                        </div>
                        <div class="single-meta">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="value">
                                   {{date('jS M, Y', strtotime($admission_query->next_follow_up_date))}}
                                </div>
                            </div>
                        </div>
                        <div class="single-meta">
