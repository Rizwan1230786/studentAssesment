...
{{--                                                {{ session()->get('message-success') }}--}}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{date('jS M, Y', strtotime($admission_query->date))}}</td>
                                        <td>{{$admission_query->last_follow_up_date != ""? date('jS M, Y', strtotime($admission_query->last_follow_up_date)):''}} </td>
                                        <td>{{date('jS M, Y', strtotime($admission_query->next_follow_up_date))}}</td>
                                        <td>
                                            <div class="dropdown">
