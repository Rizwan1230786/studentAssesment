                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" data-toggle="modal" data-target="#showCertificateModal{{$id_card->id}}"  href="#">@lang('lang.view')</a>
                                            ...
                                            <div class="modal-body">
                                                <div class="white-box radius-t-y-0">
                                                    ...
                                                    <div class="bottom-part text-center mt-5">
                                                        <img class="img-fluid w-25" src="{{asset('public/backEnd/img/logo.png')}}">
