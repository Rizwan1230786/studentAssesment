			...
			@foreach($students as $student)
                ...
                <table style="height: 800px">
                    <tr>
    			     ...
    			     <table cellpadding="0" cellspacing="0" border="0" width="180" height="321" align="center" style="margin-top: 55px;">
                        ...
                        <tr >
                            <td style="padding-left: 20px; border-left: 1px solid #ddd">Name</td>
                            <td></td>
                        ...
                        <tr >
                            <td style="padding-left: 20px; border-left: 1px solid #ddd">Admission No.</td>
                            <td></td>
                        ...
                        @if($id_card->class == 1)
                        <tr >
                            <td style="padding-left: 20px; border-left: 1px solid #ddd;">Class</td>
                            <td></td>
                        ...
                        <tr >
                            <td style="padding-left: 20px; border-left: 1px solid #ddd">Father's Name</td>
                            <td></td>
                        ...
                        <tr >
                            <td style="padding-left: 20px; border-left: 1px solid #ddd">Mother's Name</td>
                            <td></td>
                        ...
                        @if($id_card->blood == 1)
                        <tr >
                            <td style="padding-left: 20px; border-left: 1px solid #ddd">Blood Group</td>
                            <td></td>
                        ...
                        @if($id_card->phone == 1)
                        <tr >
                            <td style="padding-left: 20px; border-left: 1px solid #ddd">Phone</td>
                            <td></td>
                        ...
                        @if($id_card->dob == 1)
                        <tr >
                            <td style="padding-left: 20px; border-left: 1px solid #ddd">Date of birth</td>
                            <td></td>
                            <td style=" border-right: 1px solid #ddd; text-align: right; margin-right: 40px !important;">{{date('jS M, Y', strtotime($student->birth_of_birth))}}</td>
                        </tr>
                        @endif

                        <tr >
                            <td style="padding-left: 20px; border-left: 1px solid #ddd">{{$id_card->designation}}</td>
                            <td></td>
                            <td style=" border-right: 1px solid #ddd; text-align: right; padding-right: 20px;"><img src="{{asset($id_card->signature)}}" style="margin-right: 20px !important;"></td>
                        </tr>
                        <tr >
