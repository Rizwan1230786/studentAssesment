    ...
    <div class="container-fluid p-0">
        <div class="row">
            ...
            <div class="offset-lg-6 col-lg-2 text-right col-md-6">
                <a href="{{url('send-message')}}" class="primary-btn small fix-gr-bg">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <p class="mb-0">
                                        ...
                                        @lang('lang.publish')  @lang('lang.date') : {{date('jS M, Y', strtotime($value->publish_on))}}

                                    </p>
                                    <p class="mb-0">
                                        <span class="ti-calendar mr-10"></span>
                                        @lang('lang.notice')  @lang('lang.date') : {{date('jS M, Y', strtotime($value->notice_date))}}
                                    </p>
                                    <p>
