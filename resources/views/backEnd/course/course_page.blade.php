                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="{{url('course-Details-admin/'.$value->id)}}" class="dropdown-item small fix-gr-bg modalLink" title="Course Details" data-modal-size="full-width-modal">
                                                    @lang('lang.view')
                                                </a>
                                                <a class="dropdown-item" href="{{url('edit-course/'.$value->id)}}">@lang('lang.edit')</a>
                                                <a href="{{url('for-delete-course/'.$value->id)}}" class="dropdown-item small fix-gr-bg modalLink" title="Delete Course" data-modal-size="modal-md">
                                                    @lang('lang.delete')
                                                </a>
                                            </div>
                                        </div>
