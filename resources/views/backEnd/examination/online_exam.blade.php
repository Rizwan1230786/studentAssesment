                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{date('jS M, Y', strtotime($online_exam->date))}} <br> @lang('lang.time'): {{date("h:i A", strtotime($online_exam->start_time)).' - '.date("h:i A", strtotime($online_exam->end_time))}}</td>
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <a href="{{route('online_exam_publish', [$online_exam->id])}}">
                                             ...
                                             <a class="ml-3" href="{{route('online_exam_result', [$online_exam->id])}}">
                                                <button class="primary-btn small bg-info text-white border-0">@lang('lang.view_result')</button>
                                            </a>
                                            @endif
                                        </div>
