                                ...
                                <div class="row no-gutters input-right-icon mt-25">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input date form-control{{ $errors->has('date') ? ' is-invalid' : '' }}" id="startDate" type="text" name="date" value="{{isset($fees_master)? $fees_master->date: date('m/d/Y')}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown mb-20">
                                            {{$fees_master->feesType !=""?$fees_master->feesTypes->name:"".' '.$fees_master->amount}}
