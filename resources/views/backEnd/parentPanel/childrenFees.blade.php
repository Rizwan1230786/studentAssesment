                ...
                <table class="display school-table school-table-style-parent-fees" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{date('jS M, Y', strtotime($fees_assigned->feesGroupMaster->date))}}</td>
                            <td>
                                @if($fees_assigned->feesGroupMaster->fees_group_id != 1 && $fees_assigned->feesGroupMaster->fees_group_id != 2)
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        @if($rest_amount != 0)
                                        <a class="dropdown-item" href="{{url('collect-fees-gateway', [$rest_amount, $fees_assigned->student_id, $fees_assigned->feesGroupMaster->fees_type_id])}}" >Pay via Paypal</a>
                                        @endif

                                        @if($rest_amount != 0)
                                        <a class="dropdown-item" href="{{url('collect-fees-stripe', [$rest_amount, $fees_assigned->student_id, $fees_assigned->feesGroupMaster->fees_type_id])}}" >Pay via Stripe</a>
                                        @endif
