                        ...
                        <div class="white-box">
                            ...
                            <div class="d-flex">
                                <div class="mr-20 mt-20">
                                    <img class="student-meta-img img-100" src="{{asset($student_detail->parents->fathers_photo)}}" alt="">
                                </div>
                                <div class="w-100">
                                    <div class="single-info">
                                        <div class="row">
                            ...
                            <div class="d-flex">
                                <div class="mr-20 mt-20">
                                    <img class="student-meta-img img-100" src="{{asset($student_detail->parents->mothers_photo)}}" alt="">
                                </div>
                                <div class="w-100">
                                    <div class="single-info">
                                        <div class="row">
                            ...
                            <div class="d-flex">
                                <div class="mr-20 mt-20">
                                    <img class="student-meta-img img-100" src="{{asset($student_detail->parents->guardians_photo)}}" alt="">
                                </div>
                                <div class="w-100">
                                    <div class="single-info">
                                        <div class="row">
                                    ...
                                    <div class="single-info">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-7">
                                                <div class="">
                                                    @if(!empty($student_detail->parents))
                                                    {{$student_detail->parents->guardians_phone}}
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="single-info">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="">
                                            {{isset($student_detail->vechile_id)? $student_detail->vehicle->driver_name: ''}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-info">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="">
                                            {{$student_detail->vechile_id != ""? $student_detail->vehicle->driver_contact: ''}}
                                        </div>
                                    </div>
                                </div>
                            </div>
