                            ...
                            <div class="white-box">
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            <div class="">
                                                {{date('jS M, Y', strtotime($student_detail->admission_date))}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-7">
                                            <div class="">
                                                {{date('jS M, Y', strtotime($student_detail->date_of_birth))}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            <div class="">
                                                {{$student_detail->vechile_id != ""? $student_detail->vehicle->vehicle_no: ''}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            <div class="">
                                                {{$student_detail->driver_id != ""? $student_detail->drivers->full_name: ''}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            <div class="">
                                                {{$student_detail->driver_id != ""? $student_detail->drivers->mobile: ''}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table id="" class="table simple-table table-responsive school-table"
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-6">
                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                   href="{{url('download-document/'.showPicName($student_detail->document_file_1))}}">
                                    ...
                                    @if($student_detail->document_file_2 != "")
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-6">
                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                   href="{{url('download-document/'.showPicName($student_detail->document_file_2))}}">
                                                    @lang('lang.download')<span class="pl ti-download"></span>
                                                </a>
                                            </td>
                                        </tr>
                                    ...
                                    @if($student_detail->document_file_3 != "")
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-6">
                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                   href="{{url('download-document/'.showPicName($student_detail->document_file_3))}}">
                                                    @lang('lang.download')<span class="pl ti-download"></span>
                                                </a>
                                            </td>
                                        </tr>
                                    ...
                                    @if($student_detail->document_file_4 != "")
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-6">
                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                   href="{{url('download-document/'.showPicName($student_detail->document_file_4))}}">
                                                    @lang('lang.download')<span class="pl ti-download"></span>
                                                </a>
                                            </td>
                                        </tr>
                                    ...
                                    @foreach($documents as $document)
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-6">
                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                   href="{{url('download-document/'.showPicName($document->file))}}">
                                                    @lang('lang.download')<span class="pl ti-download"></span>
                                                </a>
                                ...
                                @foreach($timelines as $timeline)
                                    <div class="student-activities">
                                        <div class="single-activity">
                                            <h4 class="title text-uppercase">{{date('jS M, Y', strtotime($timeline->date))}}</h4>
                                            <div class="sub-activity-box d-flex">
                                                ...
                                                <div class="close-activity">
                                                    ...
                                                    @if($timeline->file != "")
                                                        <a href="{{url('download-timeline-doc/'.showPicName($timeline->file))}}"
                                                           class="primary-btn tr-bg text-uppercase bord-rad">
                                                            @lang('lang.download')<span class="pl ti-download"></span>
                                                        </a>
                                                    @endif
