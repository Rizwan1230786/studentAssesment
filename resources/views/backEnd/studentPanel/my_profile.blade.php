                        ...
                        <div class="white-box">
                            ...
                            <div class="single-info">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="">
                                            {{$student_detail->vehicle != ""? $student_detail->vehicle->driver_name: ''}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-info">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="">
                                            {{$student_detail->vehicle != ""? $student_detail->vehicle->driver_contact: ''}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="" class="table simple-table table-responsive school-table"
                                ...
                                <tbody class="d-block">
                                    ...
                                    <tr class="d-flex">
                                        ...
                                        <td class="col-3">
                                            <a class="primary-btn tr-bg text-uppercase bord-rad" href="{{url('download-document/'.showPicName($document->file))}}">
