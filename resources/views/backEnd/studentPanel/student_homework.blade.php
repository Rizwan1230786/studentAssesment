                    ...
                    <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$value->marks}}</td>
                                 <td>{{date('jS M, Y', strtotime($value->homework_date))}}</td>
                                 <td>{{date('jS M, Y', strtotime($value->submission_date))}}</td>
                                <td>
                                @if(!empty($value->evaluation_date))
                                {{date('jS M, Y', strtotime($value->evaluation_date))}}
                                @endif
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                         ...
                                         <a class="dropdown-item modalLink" title="Homework View" data-modal-size="modal-lg" href="{{route('student_homework_view', [$value->class_id, $value->section_id, $value->id])}}">View</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
