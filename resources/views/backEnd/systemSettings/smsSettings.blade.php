...
<section class="mb-40 student-details">
    <div class="container-fluid p-0">
        <div class="row">
                        ...
                        <div class="col-lg-4 select_sms_services">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('book_category_id') ? ' is-invalid' : '' }}" name="sms_service" id="sms_service">
                                        ...
                                        @if(isset($active_sms_service))
                                        @if($active_sms_service->id == $value->id)
                                        selected
                                        @endif
                                        @endif
                                        >{{$value->gateway_name}}</option>
                                        @endforeach
                                        @endif
                                    </select>
            ...
            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'update-twilio-data', 'id' => 'msg91_form']) }}
                <div class="white-box">
                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label> @lang('lang.authentication_key_SID')<span>*</span> </label>
                                                <span class="focus-border"></span>
                                                @if ($errors->has('book_title'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('book_title') }}</strong>
