                            ...
                            <div class="add-visitor">
                               ...
                               {{-- 
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input class="primary-input form-control{{ $errors->has('driver_name') ? ' is-invalid' : '' }}"
                                                type="text" placeholder="" name="driver_name" autocomplete="off" value="{{isset($assign_vehicle)? $assign_vehicle->driver_name:old('driver_name')}}">
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input class="primary-input form-control{{ $errors->has('driver_license') ? ' is-invalid' : '' }}"
                                                type="text" name="driver_license" autocomplete="off" value="{{isset($assign_vehicle)? $assign_vehicle->driver_license:old('driver_license')}}">
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input class="primary-input form-control{{ $errors->has('driver_contact') ? ' is-invalid' : '' }}"
                                                type="text" name="driver_contact" autocomplete="off" value="{{isset($assign_vehicle)? $assign_vehicle->driver_contact:old('driver_contact')}}">
