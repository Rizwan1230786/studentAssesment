...
<head>
    ...
    <link rel="icon" href="{{asset('public/backEnd/')}}/img/logo.jpg" type="image/png" />
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container box-1420">
                ...
                <a class="navbar-brand" href="{{url('/')}}/home">
                    <img style="width: 260px; margin-top:5px;" src="{{asset('images/Stulogo2.jpg')}}" alt="">
                </a>
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{url('/')}}/news-page">News</a></li>
