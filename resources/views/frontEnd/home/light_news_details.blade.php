                ...
                <div class="col-lg-9">
                    ...
                    <div class="meta mb-30 d-flex flex-md-row flex-column">
                        <div class="date text-uppercase">
                            ...
                            {{date('jS M, Y', strtotime($news->publish_date))}}
                        </div>
                        <div class="date text-uppercase">
                            ...
                            <div class="notice-board">
                                ...
                                @foreach($notice_board as $notice)
                                    <div class="notice-item">
                                        <p class="date">{{date('jS M, Y', strtotime($notice->publish_on))}}</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="news-item">
                                ...
                                <div class="news-text">
                                    <p class="date">{{date('jS M, Y', strtotime($theNews->publish_date))}}</p>
                                    <h4>
