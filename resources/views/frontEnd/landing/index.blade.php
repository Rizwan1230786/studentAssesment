                    ...
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <a id="play-video_1" class="btn_1 popup-youtube" href="#"> <i class="ti-control-play"></i> 
                                Video Overview</a>
                            <a href="{{url('/login')}}" class="btn_2"> <i class="ti-package"></i> Try Live Demo</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-center"
                            ...
                            <ul class="navbar-nav align-items-center">
                                <li class="nav-item active">
                                    <a class="nav-link" href="{{url('/')}}">Demo</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item"> 
                                    <a class="nav-link" href="{{url('/home')}}">Frontend</a> 
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p><a class="support-link" href="{{url('/')}}"> Submit a Ticket </a></p>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><i class="ti-write"></i></span>
                            <p><a class="support-link" href="{{url('/docs')}}"> Documentation</a></p>
                        </div>
                    </div>
                </div>
            </div>
