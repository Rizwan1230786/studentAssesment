...
Route::get('course-Details/{id}', 'SmFrontendController@courseDetails');
Route::get('news', 'SmFrontendController@news');
Route::get('news-page', 'SmFrontendController@newsPage');
Route::get('contact', 'SmFrontendController@contact');
Route::get('news-details/{id}', 'SmFrontendController@newsDetails');
...
Route::group(['middleware' => ['CheckUserMiddleware']], function () {
    ...
    Route::get('login', 'Auth\LoginController@loginFormTwo')->name('login');  //for demo user 
    // Route::get('login', 'Auth\LoginController@showLoginForm')->name('login'); //for final output
...
//naim
	...
	Route::get('exam-marks-setup/{id}', 'SmExamController@exam_setup');
...
// }            
   ...
   Route::get('/install', 'InstallController@show_welcome_screen')->name('show_welcome_screen');
   Route::get('/purchase-verification', 'InstallController@purchase_verification_form')->name('purchase_verification_form'); 
   Route::post('/purchase-verified-check', 'InstallController@purchase_verified_check')->name('purchase_verified_check'); 
   Route::get('/environment-setup', 'InstallController@environment_setup')->name('environment_setup'); 
   Route::post('/system-setting-form', 'InstallController@system_setting_form')->name('system_setting_form'); 
   Route::post('/system-setting-install', 'InstallController@system_setting_install')->name('system_setting_install'); 
   ...
   // Route::post('/purchaseVerificationVerify', 'InstallController@installStep1')->name('purchaseVerificationVerify');
