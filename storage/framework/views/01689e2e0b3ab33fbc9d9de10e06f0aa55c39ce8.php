...
<section class="admin-visitor-area">
    ...
    <div class="row mb-30">
     <div class="col-lg-3">
        <div class="no-gutters input-right-icon">
            <div class="col">
                <div class="input-effect">
                    <input class="primary-input date form-control<?php echo e($errors->has('homework_date') ? ' is-invalid' : ''); ?>" id="homework_date" type="text" name="homework_date" value="<?php echo e(old('homework_date') != ""? old('homework_date'): date('m/d/Y')); ?>" readonly="true">
                    <label><?php echo app('translator')->getFromJson('lang.home_work'); ?> <?php echo app('translator')->getFromJson('lang.date'); ?> <span>*</span></label>
                    <span class="focus-border"></span>
    ...
    <div class="col-lg-3">
        <div class="no-gutters input-right-icon">
            <div class="col">
                <div class="input-effect">
                    <input class="primary-input date form-control<?php echo e($errors->has('submission_date') ? ' is-invalid' : ''); ?>" id="submission_date" type="text" name="submission_date" value="<?php echo e(old('submission_date') != ""? old('submission_date') : date('m/d/Y')); ?>" readonly="true">
                    <label><?php echo app('translator')->getFromJson('lang.submission'); ?> <?php echo app('translator')->getFromJson('lang.date'); ?> <span>*</span></label>
                    <span class="focus-border"></span>
    ...
    <div class="col-lg-3">
        <div class="row no-gutters input-right-icon">
            <div class="col">
                <div class="input-effect">
                    <input class="primary-input form-control<?php echo e($errors->has('marks') ? ' is-invalid' : ''); ?>" type="text" name="marks" value="<?php echo e(old('marks')); ?>">
...
<div class="col-lg-3">
    <div class="row no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input" type="text" id="placeholderHomeworkName" placeholder="<?php echo app('translator')->getFromJson('lang.attach_file'); ?>"
                disabled>
                <span class="focus-border"></span>
            </div>
        </div>
        <div class="col-auto">
            <button class="primary-btn-small-input" type="button">
                <label class="primary-btn small fix-gr-bg" for="homework_file"><?php echo app('translator')->getFromJson('lang.browse'); ?></label>
...
<div class="row md-20">
    <div class="col-lg-12">
        <div class="input-effect">
            <textarea class="primary-input form-control<?php echo e($errors->has('description') ? ' is-invalid' : ''); ?>" cols="0" rows="4" name="description" id="description *"><?php echo e(old('description')); ?></textarea>
