    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="<?php echo e(url('student_view_result')); ?>">View result</a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <?php $__currentLoopData = $result_views; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result_view): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo e(date('jS M, Y', strtotime($result_view->onlineExam->date))); ?> <br> Time: <?php echo e($result_view->onlineExam->start_time.' - '.$result_view->onlineExam->end_time); ?>
                                        ...
                                        <td>
                                            <a class="btn btn-success modalLink" data-modal-size="modal-lg" title="Answer Script"  href="<?php echo e(route('student_answer_script', [$result_view->online_exam_id, $result_view->student_id])); ?>" >Answer Script</a>
                                        </td>
                                    </tr>
