        ...
        <div class="card">
            ...
            <div class="card-body" style="text-align: center; min-height: 350px">
                  ...
                  <span class="text-center pull-center" style="text-align: center; margin-top: 45px">
                       <a href="<?php echo e(url('/purchase-verification')); ?>" class="primary-btn fix-gr-bg text-center" style="background-color: rebeccapurple;color: whitesmoke;     margin-top: 100px;"> Start </a>
                  </span>
