                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-lg-6 text-right">
                                    <a href="<?php echo e(url('add-new-routine', [$class_time->id, $sm_weekend->id, $class_id, $section_id])); ?>" class="primary-btn small tr-bg icon-only mr-10 modalLink" data-modal-size="modal-md" title="Create Class routine">
