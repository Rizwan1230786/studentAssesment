            ...
            <div class="card-body environment-setup"> 
                ...
                <div class="requirements">
                   <table class="table">
                       ...
                       <tr>
                           ...
                           <td style='color: green'><?php echo e(phpversion()); ?></td>
                           <td>PHP >= 7.1.3</td>
                       </tr>
                       <tr>
                           <td>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 text-center">
                        ...
                        <?php if(! is_writable(dirname($folder))): ?>
                        <span class="ti-check-box" style="color: green"></span>
                            <?php else: ?>
                    ...
                    <div class="col-lg-4"> 
                        ...
                        <?php if(! is_writable(dirname($folder))): ?>
                            <span style="color: green"><?php echo e($folder); ?></span>
                        <?php else: ?>
                            <span style="color: red"><?php echo e($folder); ?> </span>
                        <?php endif; ?>

                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
                <form action="<?php echo e(route('system_setting_form')); ?>" method="post">
