                    ...
                    <div class="white-box radius-t-y-0 student-details">
                        ...
                        <div class="single-meta">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="value">
                                    <?php echo e(date('jS M, Y', strtotime($admission_query->date))); ?>
                        ...
                        <div class="single-meta">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="value">
                                     <?php echo e($admission_query->last_follow_up_date != ""? date('jS M, Y', strtotime($admission_query->date)):''); ?>
                        ...
                        <div class="single-meta">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="value">
                                   <?php echo e(date('jS M, Y', strtotime($admission_query->next_follow_up_date))); ?>
