...
<div class="container">
    <div class="col-md-6 offset-3  mt-40">
        ...
        <div class="card">
            ...
            <div class="card-body">
                  <p style="text-align: center">Thank you for choosing Infixedu for your school administration. Please follow the steps to complete Infixedu installation</p>

               <a href="<?php echo e(url('/install1')); ?>"><button type="submit" class="offset-3 col-sm-6 primary-btn fix-gr-bg" style="background-color: rebeccapurple;color: whitesmoke">
                       Start
                   </button></a>
            </div>
        </div>
