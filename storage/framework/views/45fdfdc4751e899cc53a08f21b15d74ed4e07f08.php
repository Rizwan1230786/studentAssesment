                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->getFromJson('lang.deposit'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo e(date('jS M, Y', strtotime($fees_due->studentInfo->date_of_birth))); ?>

                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($fees_due->feesGroupMaster !=""): ?>
                                            <?php echo e(date('jS M, Y', strtotime($fees_due->feesGroupMaster->date))); ?>
