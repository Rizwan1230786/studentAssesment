                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->getFromJson('lang.income'); ?>($)</th>
                                        <th><?php echo app('translator')->getFromJson('lang.expense'); ?>($)</th>
                                        <th><?php echo app('translator')->getFromJson('lang.profit'); ?>($)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                   
                                    <tr>
                                        <td><?php echo e(isset($date_from)? date('jS M, Y', strtotime($date_from)).' - '.date('jS M, Y', strtotime($date_to)): "All"); ?></td>
