                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" data-toggle="modal" data-target="#showCertificateModal<?php echo e($id_card->id); ?>"  href="#"><?php echo app('translator')->getFromJson('lang.view'); ?></a>
                                            ...
                                            <div class="modal-body">
                                                <div class="white-box radius-t-y-0">
                                                    ...
                                                    <div class="bottom-part text-center mt-5">
                                                        <img class="img-fluid w-25" src="<?php echo e(asset('public/backEnd/img/logo.png')); ?>">
