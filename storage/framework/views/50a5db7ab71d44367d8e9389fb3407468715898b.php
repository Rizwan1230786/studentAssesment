                    ...
                    <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                         <input name="date_from" class="primary-input date" type="text" autocomplete="off" value="<?php echo e(isset($date_from)? ($date_from != ""? $date_from:''):''); ?>">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                         <input name="date_to" class="primary-input date" type="text" autocomplete="off" value="<?php echo e(isset($date_to)? ($date_to != ""? $date_to:''):''); ?>">
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e(date('jS M, Y', strtotime($admission_query->date))); ?></td>
                                        <td><?php echo e($admission_query->last_follow_up_date != ""? date('jS M, Y', strtotime($admission_query->last_follow_up_date)):''); ?> </td>
                                        <td><?php echo e(date('jS M, Y', strtotime($admission_query->next_follow_up_date))); ?></td>
                                        <td>
                                            <div class="dropdown">
