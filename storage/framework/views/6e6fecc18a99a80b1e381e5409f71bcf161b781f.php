                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row no-gutters input-right-icon mt-25">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input date form-control<?php echo e($errors->has('date') ? ' is-invalid' : ''); ?>" id="startDate" type="text" name="date" value="<?php echo e(isset($postal_dispatch)? $postal_dispatch->date: date('m/d/Y')); ?>">
                                            <span class="focus-border"></span>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(date('jS M, Y', strtotime($postal_dispatch->date))); ?></td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <?php if($postal_dispatch->file != ""): ?>
                                                 <a class="dropdown-item" href="<?php echo e(url('postal-dispatch-document/'.showPicName($postal_dispatch->file))); ?>">
