       ...
       <div class="single-meta">
        <div class="d-flex justify-content-between">
            ...
            <div class="value">
                ...
                <?php echo e(date('jS M, Y', strtotime($staffDetails->date_of_joining))); ?>
    ...
    <div class="tab-content">
        ...
        <div class="single-info">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    <div class="">
                        <?php if(isset($staffDetails)): ?><?php echo e(date('jS M, Y', strtotime($staffDetails->date_of_birth))); ?><?php endif; ?>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                    ...
                    <tbody>
                       ...
                       <tr>
                        ...
                        <td><?php echo e(date('jS M, Y', strtotime($value->leave_from))); ?></td>
                        <td><?php echo e(date('jS M, Y', strtotime($value->leave_to))); ?></td>
                        <td><?php echo e(date('jS M, Y', strtotime($value->apply_date))); ?></td>
                        <td>
            ...
            <tbody class="d-block">
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-4">
                        ...
                        <a class="primary-btn icon-only fix-gr-bg modalLink" title="Delete Document" data-modal-size="modal-md"  href="<?php echo e(url('delete-staff-document-view/'.$value->id)); ?>">
