            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <div class="offset-lg-12 col-lg-12 text-right col-md-12 mb-20">
                        <a href="<?php echo e(url('get-backup-files/1')); ?>" class="primary-btn small fix-gr-bg  "  >
                            <span class="ti-arrow-circle-down pr-2"></span>
                            Images <?php echo app('translator')->getFromJson('lang.backup'); ?>
                        </a>
                        <a href="<?php echo e(url('get-backup-files/2')); ?>" class="primary-btn small fix-gr-bg  " >
                            <span class="ti-arrow-circle-down pr-2"></span>
                            Full Project <?php echo app('translator')->getFromJson('lang.backup'); ?>
                        </a>
                        <a href="<?php echo e(url('get-backup-db')); ?>" class="primary-btn small fix-gr-bg  " >
                            <span class="ti-arrow-circle-down pr-2"></span>
