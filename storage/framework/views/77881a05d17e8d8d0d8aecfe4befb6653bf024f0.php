                            ...
                            <div class="white-box">
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            <div class="">
                                                <?php echo e(date('jS M, Y', strtotime($student_detail->admission_date))); ?>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-7">
                                            <div class="">
                                                <?php echo e(date('jS M, Y', strtotime($student_detail->date_of_birth))); ?>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            <div class="">
                                                <?php echo e($student_detail->vechile_id != ""? $student_detail->vehicle->vehicle_no: ''); ?>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            <div class="">
                                                <?php echo e($student_detail->driver_id != ""? $student_detail->drivers->full_name: ''); ?>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            <div class="">
                                                <?php echo e($student_detail->driver_id != ""? $student_detail->drivers->mobile: ''); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(!empty($fees_assigned->feesGroupMaster)): ?>
                                                <?php echo e(date('jS M, Y', strtotime($fees_assigned->feesGroupMaster->date))); ?>
                                ...
                                <table id="" class="table simple-table table-responsive school-table"
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-6">
                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                   href="<?php echo e(url('download-document/'.showPicName($student_detail->document_file_1))); ?>">
                                    ...
                                    <?php if($student_detail->document_file_2 != ""): ?>
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-6">
                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                   href="<?php echo e(url('download-document/'.showPicName($student_detail->document_file_2))); ?>">
                                                    <?php echo app('translator')->getFromJson('lang.download'); ?><span class="pl ti-download"></span>
                                                </a>
                                            </td>
                                        </tr>
                                    ...
                                    <?php if($student_detail->document_file_3 != ""): ?>
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-6">
                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                   href="<?php echo e(url('download-document/'.showPicName($student_detail->document_file_3))); ?>">
                                                    <?php echo app('translator')->getFromJson('lang.download'); ?><span class="pl ti-download"></span>
                                                </a>
                                            </td>
                                        </tr>
                                    ...
                                    <?php if($student_detail->document_file_4 != ""): ?>
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-6">
                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                   href="<?php echo e(url('download-document/'.showPicName($student_detail->document_file_4))); ?>">
                                                    <?php echo app('translator')->getFromJson('lang.download'); ?><span class="pl ti-download"></span>
                                                </a>
                                            </td>
                                        </tr>
                                    ...
                                    <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-6">
                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                   href="<?php echo e(url('download-document/'.showPicName($document->file))); ?>">
                                                    <?php echo app('translator')->getFromJson('lang.download'); ?><span class="pl ti-download"></span>
                                                </a>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            ...
                                                            <a class="primary-btn fix-gr-bg"
                                                               href="<?php echo e(route('delete_document', [$document->id])); ?>">
                                ...
                                <?php $__currentLoopData = $timelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="student-activities">
                                        <div class="single-activity">
                                            <h4 class="title text-uppercase"><?php echo e(date('jS M, Y', strtotime($timeline->date))); ?></h4>
                                            <div class="sub-activity-box d-flex">
                                                ...
                                                <div class="close-activity">
                                                    ...
                                                    <?php if($timeline->file != ""): ?>
                                                        <a href="<?php echo e(url('download-timeline-doc/'.showPicName($timeline->file))); ?>"
                                                           class="primary-btn tr-bg text-uppercase bord-rad">
                                                            <?php echo app('translator')->getFromJson('lang.download'); ?><span class="pl ti-download"></span>
                                                        </a>
                                                    <?php endif; ?>
