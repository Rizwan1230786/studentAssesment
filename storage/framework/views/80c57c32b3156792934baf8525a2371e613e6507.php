                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('driver') ? ' is-invalid' : ''); ?>" name="driver_id" id="">
                                        ...
                                        <option value="<?php echo e($driver->id); ?>" <?php echo e(old('driver') == $driver->id? 'selected': ''); ?>><?php echo e($driver->full_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <span class="focus-border"></span>
                                    <?php if($errors->has('class')): ?>
                                ...
                                <div class="input-effect" id="roomNumberDiv">
                                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('room_number') ? ' is-invalid' : ''); ?>" name="room_number" id="selectRoomNumber">
                                        ...
                                        <?php if($student->room_id != ""): ?>
                                            <option value="<?php echo e($student->room_id); ?>" selected="true"}}><?php echo e($student->room->name); ?></option>
                                        <?php endif; ?>
