...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        ...
        <h1><?php echo app('translator')->getFromJson('lang.admin_setup'); ?></h1>
        <div class="bc-pages">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input class="primary-input form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>"
                                                type="text" name="name" value="<?php echo e(isset($admin_setup)? $admin_setup->name: ''); ?>">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="<?php echo e(url('setup-admin', [$admin_setup->id
