        ...
        <?php if(Auth::user()->role_id != 2 && Auth::user()->role_id != 3 && Auth::user()->role_id != 10 ): ?>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuTeacher">
                    <?php if(in_array(20, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuFeesCollection">
                     <?php if(in_array(25, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="<?php echo e(route('collect_fees')); ?>"><?php echo app('translator')->getFromJson('lang.collect_fees'); ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array(26, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuHumanResource">
                    <?php if(in_array(40, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                   ...
                   <?php endif; ?>
                    <?php if(in_array(44, $module_links) || Auth::user()->role_id == 1): ?>
                     ...
                     <?php endif; ?>
                     <?php if(in_array(46, $module_links) || Auth::user()->role_id == 1): ?>
                     <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuLeaveManagement">
                    <?php if(in_array(47, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="<?php echo e(url('approve-leave')); ?>"><?php echo app('translator')->getFromJson('lang.approve_leave_request'); ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array(48, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                    ...
                    <?php endif; ?>
                    <?php if(in_array(50, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuExam">
                    <?php if(in_array(51, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="<?php echo e(url('exam-type')); ?>"><?php echo app('translator')->getFromJson('lang.add_exam_type'); ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array(52, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuAcademic">
                    <?php if(in_array(61, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                    ...
                    <?php endif; ?>
                    <?php if(in_array(63, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <?php if(in_array(11, $modules) || Auth::user()->role_id == 1): ?>
             <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuHomework">
                    <?php if(in_array(69, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuCommunicate">
                    <?php if(in_array(72, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="<?php echo e(url('notice-list')); ?>"><?php echo app('translator')->getFromJson('lang.notice_board'); ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array(73, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                         <a href="<?php echo e(url('send-message')); ?>"><?php echo app('translator')->getFromJson('lang.send_message'); ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array(74, $module_links) || Auth::user()->role_id == 1): ?>
                     <li>
                         <a href="<?php echo e(url('send-email-sms-view')); ?>"><?php echo app('translator')->getFromJson('lang.send_email'); ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array(75, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenulibrary">
                    ...
                    <?php endif; ?>
                    <?php if(in_array(82, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuInventory">
                    ...
                    <?php endif; ?>
                    <?php if(in_array(89, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="<?php echo e(url('item-sell-list')); ?>"><?php echo app('translator')->getFromJson('lang.item_sell'); ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array(90, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuTransport">
                    <?php if(in_array(91, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                    ...
                    <?php endif; ?>
                    <?php if(in_array(93, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="<?php echo e(url('assign-vehicle')); ?>"><?php echo app('translator')->getFromJson('lang.assign_vehicle'); ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array(94, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuDormitory">
                    <?php if(in_array(95, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                    ...
                    <?php endif; ?>
                    <?php if(in_array(97, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="<?php echo e(url('room-type')); ?>"><?php echo app('translator')->getFromJson('lang.room_type'); ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array(98, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenusystemReports">
                    <?php if(in_array(99, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                    ...
                    <?php endif; ?>
                    <?php if(in_array(114, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="<?php echo e(route('progress_card_report')); ?>">Progress Card Report</a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array(115, $module_links) || Auth::user()->role_id == 1): ?>
                    <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenusystemSettings">
                    ...
                    <li>
                        <a href="<?php echo e(route('base_group')); ?>"><?php echo app('translator')->getFromJson('lang.base_group'); ?></a>
                    </li>
                    <?php endif; ?>
            ...
            <?php if(in_array(19, $modules) || Auth::user()->role_id == 1): ?>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="subMenufrontEndSettings">
                        ...
                        <li>
                            <a href="<?php echo e(url('course-list')); ?>">Course List</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('contact-page')); ?>">Contact Page</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('contact-message')); ?>">Contact Message</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('about-page')); ?>">About Us</a>
                        </li>
                    </ul>
                </li>
            <?php endif; ?>
