                            ...
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    <textarea class="primary-input form-control" cols="0" rows="4" name="reason"><?php echo e(isset($apply_leave)? $apply_leave->reason: ''); ?></textarea>
                                     <label>Reason <?php echo app('translator')->getFromJson('lang.reason'); ?> <span>*</span> </label>
                ...
                <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(date('jS M, Y', strtotime($apply_leave->leave_from))); ?></td>
                            <td><?php echo e(date('jS M, Y', strtotime($apply_leave->leave_to))); ?></td>
                            <td><?php echo e(date('jS M, Y', strtotime($apply_leave->apply_date))); ?></td>
                            <td>
