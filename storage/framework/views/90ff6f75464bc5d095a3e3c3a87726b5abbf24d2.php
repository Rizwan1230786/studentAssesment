                    ...
                    <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(date('jS M, Y', strtotime($value->sell_date))); ?></td>
                                            ...
                                            <?php endif; ?>
                                             ...
                                             <?php if($value->paid_status != 'P'): ?>
                                              ...
                                              <?php endif; ?>
                                                ...
                                                <a class="dropdown-item deleteUrl" data-modal-size="modal-md" title="Delete Sold Item" href="<?php echo e(url('delete-item-receive-view', $value->id)); ?>"><?php echo app('translator')->getFromJson('lang.delete'); ?></a>
                                                <?php endif; ?>
                                                <?php endif; ?>
