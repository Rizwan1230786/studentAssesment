                ...
                <li class="nav-item">
                    ...
                    <select class="niceSelect languageChange" name="languageChange" id="languageChange">
                        ...
                        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option data-display="<?php echo e($lang->native); ?>"
                                    value="<?php echo e(URL::to('/locale/'.$lang->language_universal)); ?>"><?php echo e($lang->native); ?></option>
                        ...
                        <div class="dropdown-menu profile-box">
                            <div class="white-box">
                                <a class="dropdown-item" href="#">
                                    <div class="">
                                        <div class="d-flex">
                                            <img class="client_img" src="<?php echo e(asset($profile)); ?>" alt="">
