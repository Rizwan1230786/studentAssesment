            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <div class="offset-lg-12 col-lg-12 text-right col-md-12 mb-20">
                        <a href="<?php echo e(url('get-backup-files/1')); ?>" class="primary-btn small fix-gr-bg isDisabled"   data-toggle="tooltip" title="Disabled for demo version" >
                            <span class="ti-arrow-circle-down pr-2"></span>
                            Images <?php echo app('translator')->getFromJson('lang.backup'); ?>
                        </a>
                        <a href="<?php echo e(url('get-backup-files/2')); ?>" class="primary-btn small fix-gr-bg isDisabled"  data-toggle="tooltip" title="Disabled for demo version" >
                            <span class="ti-arrow-circle-down pr-2"></span>
                            Full Project <?php echo app('translator')->getFromJson('lang.backup'); ?>
                        </a>
                        <a href="<?php echo e(url('get-backup-db')); ?>" class="primary-btn small fix-gr-bg isDisabled"  data-toggle="tooltip" title="Disabled for demo version" >
                            <span class="ti-arrow-circle-down pr-2"></span>
 
                           Database <?php echo app('translator')->getFromJson('lang.backup'); ?>
                        ...
                        <table class="display school-table school-table-style" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(date('jS M, Y h:i A', strtotime($sms_db->created_at))); ?></td>
                                    ...
                                    <td>
                                        <a  class="primary-btn small tr-bg isDisabled" href="<?php echo e(url('/download-files/'.$sms_db->id)); ?>"  data-toggle="tooltip" title="Disabled for demo version" >
 
                                            <span class="pl ti-download"></span> <?php echo app('translator')->getFromJson('lang.download'); ?>
                                        </a>
                                        <a  class="primary-btn small tr-bg isDisabled" href="<?php echo e(url('/restore-database/'.$sms_db->id)); ?>"  data-toggle="tooltip" title="Disabled for demo version" >
                                        ...
                                        <a data-target="#deleteDatabase<?php echo e($sms_db->id); ?>"  class="primary-btn small tr-bg isDisabled" href="<?php echo e(url('/'.$sms_db->id)); ?>"  data-toggle="tooltip" title="Disabled for demo version" >
