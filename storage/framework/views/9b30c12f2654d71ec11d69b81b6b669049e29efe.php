                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"> <?php echo app('translator')->getFromJson('lang.news'); ?> <?php echo app('translator')->getFromJson('lang.category'); ?> <?php echo app('translator')->getFromJson('lang.list'); ?></h3>
                            </div>
                        </div>
                    </div>
