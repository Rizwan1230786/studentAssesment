    ...
    <div class="col-md-6 offset-3  mt-40">
        ...
        <div class="card">
            ...
            <div class="card-body">
               ...
               <form method="post" action="<?php echo e(route('purchase_verified_check')); ?>">
                   ...
                   <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="purchase_code" value="">
                   ...
                   <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="purchase_domain" value="">
                       <?php if($errors->has('purchase_domain')): ?>
                          <div class="error text-danger"><?php echo e($errors->first('purchase_domain')); ?></div>
                      <?php endif; ?>
                   </div>
