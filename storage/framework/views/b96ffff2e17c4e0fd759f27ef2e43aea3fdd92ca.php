                ...
                <div class="white-box">
                    <div class="">
                        ...
                        <div class="row mb-40 mt-30">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <input class="primary-input read-only-input" type="number" id="roll_number" name="roll_number" readonly <?php echo e(old('roll_number')); ?>>
                        ...
                        <div class="row mt-40">
                         ...
                         <div class="row mb-40 mt-30">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('driver') ? ' is-invalid' : ''); ?>" name="driver_id" id="">
                                        <option data-display="<?php echo app('translator')->getFromJson('lang.driver'); ?> <?php echo app('translator')->getFromJson('lang.name'); ?>" value=""><?php echo app('translator')->getFromJson('lang.driver'); ?> <?php echo app('translator')->getFromJson('lang.name'); ?></option>
                                        <?php $__currentLoopData = $driver_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($driver->id); ?>" <?php echo e(old('driver_id') == $driver->id? 'selected': ''); ?>><?php echo e($driver->full_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <span class="focus-border"></span>
                                    <?php if($errors->has('class')): ?>
