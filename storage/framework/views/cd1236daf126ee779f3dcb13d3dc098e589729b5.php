                                        ...
                                        <td>
                                            ...
                                            <?php if($sms_language->active_status==1): ?>
                                                <a href="<?php echo e(URL::to('/change-language/'.$sms_language->id)); ?>"
                                                   class="<?php echo e($sms_language->active_status==1?$active:$inactive); ?> isDisabled"  data-toggle="tooltip" title="Disabled for demo version"> <span
                                            ...
                                            <a href="<?php echo e(url('/')); ?>/language-setup/<?php echo e($sms_language->language_universal); ?> "
                                               class="primary-btn small tr-bg isDisabled"  data-toggle="tooltip" title="Disabled for demo version"> <span
                                                    class="ti-settings"></span> <?php echo app('translator')->getFromJson('lang.setup'); ?> </a>

                                            <?php if($sms_language->language_universal !='en'): ?>
                                            
                                                <a 
                                                   href="<?php echo e(url('/')); ?>/language-delete" class="primary-btn small tr-bg isDisabled"  data-toggle="tooltip" title="Disabled for demo version">
                                                    <span class="ti-close"></span> <?php echo app('translator')->getFromJson('lang.delete'); ?> </a>
                                                <a class="primary-btn small tr-bg isDisabled"  data-toggle="tooltip" title="Disabled for demo version"
                                                   href="<?php echo e(url('/language-edit')); ?>/<?php echo e($sms_language->id); ?>"> <span
                                                        class="ti-pencil-alt"></span> <?php echo app('translator')->getFromJson('lang.edit'); ?>  </a>
                                            <?php else: ?>
