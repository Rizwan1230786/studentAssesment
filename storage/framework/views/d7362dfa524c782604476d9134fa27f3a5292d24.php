...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.phone_call_log'); ?></h1>
            <div class="bc-pages">
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(date('jS M, Y', strtotime($phone_call_log->date))); ?></td>
                                    <td><?php echo e(date('jS M, Y', strtotime($phone_call_log->next_follow_up_date))); ?></td>
