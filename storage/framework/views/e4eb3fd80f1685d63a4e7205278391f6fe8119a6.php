                        ...
                        <div class="white-box">
                            ...
                            <div class="single-info">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="">
                                            <?php echo e($student_detail->vehicle != ""? $student_detail->vehicle->driver_name: ''); ?>
                            ...
                            <div class="single-info">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="">
                                            <?php echo e($student_detail->vehicle != ""? $student_detail->vehicle->driver_contact: ''); ?>
                            ...
                            <table id="" class="table simple-table table-responsive school-table"
                                ...
                                <tbody class="d-block">
                                    ...
                                    <tr class="d-flex">
                                        ...
                                        <td class="col-3">
                                            <a class="primary-btn tr-bg text-uppercase bord-rad" href="<?php echo e(url('download-document/'.showPicName($document->file))); ?>">
