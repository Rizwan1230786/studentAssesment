                            ...
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-10">
                                        ...
                                        <label for="basicSalary"><?php echo app('translator')->getFromJson('lang.basic_salary'); ?></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30">
                                        ...
                                        <label for="gross_salary"><?php echo app('translator')->getFromJson('lang.gross_salary'); ?></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30 mb-30">
                                        ...
                                        <label for="net_salary"><?php echo app('translator')->getFromJson('lang.net_salary'); ?></label>
                                        <span class="focus-border"></span>
