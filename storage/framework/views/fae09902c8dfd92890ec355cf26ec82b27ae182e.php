                                ...
                                <div class="row no-gutters input-right-icon mt-25">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input date form-control<?php echo e($errors->has('date') ? ' is-invalid' : ''); ?>" id="startDate" type="text" name="date" value="<?php echo e(isset($fees_master)? $fees_master->date: date('m/d/Y')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown mb-20">
                                            <?php echo e($fees_master->feesType !=""?$fees_master->feesTypes->name:"".' '.$fees_master->amount); ?>
