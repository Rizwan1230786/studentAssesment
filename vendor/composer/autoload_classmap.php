...
return array(
    ...
    'GlobalVariable' => $baseDir . '/database/seeds/GlobalVariable.php',
    ...
    'SmAcademicYearsTableSeeder' => $baseDir . '/database/seeds/SmAcademicYearsTableSeeder.php',
    'SmAssignSubjectsTableSeeder' => $baseDir . '/database/seeds/SmAssignSubjectsTableSeeder.php',
    'SmBankAccountTableSeeder' => $baseDir . '/database/seeds/SmBankAccountTableSeeder.php',
    'SmBaseSetupsTableSeeder' => $baseDir . '/database/seeds/SmBaseSetupsTableSeeder.php',
    'SmBookCategoriesTableSeeder' => $baseDir . '/database/seeds/SmBookCategoriesTableSeeder.php',
    'SmClassRoomsSeeder' => $baseDir . '/database/seeds/SmClassRoomsSeeder.php',
    'SmClassTimesTableSeeder' => $baseDir . '/database/seeds/SmClassTimesTableSeeder.php',
    'SmComplaintTableSeeder' => $baseDir . '/database/seeds/SmComplaintTableSeeder.php',
    'SmDesignationsTableSeeder' => $baseDir . '/database/seeds/SmDesignationsTableSeeder.php',
    'SmExamTypeSeeder' => $baseDir . '/database/seeds/SmExamTypeSeeder.php',
    'SmExpenseHeadTableSeeder' => $baseDir . '/database/seeds/SmExpenseHeadTableSeeder.php',
    'SmFeesMasterTableSeeder' => $baseDir . '/database/seeds/SmFeesMasterTableSeeder.php',
    'SmFeesTypeTableSeeder' => $baseDir . '/database/seeds/SmFeesTypeTableSeeder.php',
    'SmHourlyRateTableSeeder' => $baseDir . '/database/seeds/SmHourlyRateTableSeeder.php',
    'SmHrPayrollGenerateTableSeeder' => $baseDir . '/database/seeds/SmHrPayrollGenerateTableSeeder.php',
    'SmHumanDepartmentsTableSeeder' => $baseDir . '/database/seeds/SmHumanDepartmentsTableSeeder.php',
    'SmIncomeHeadTableSeeder' => $baseDir . '/database/seeds/SmIncomeHeadTableSeeder.php',
    'SmInstructionTableSeeder' => $baseDir . '/database/seeds/SmInstructionTableSeeder.php',
    'SmLeaveTypesTableSeeder' => $baseDir . '/database/seeds/SmLeaveTypesTableSeeder.php',
    'SmLibraryMembersTableSeeder' => $baseDir . '/database/seeds/SmLibraryMembersTableSeeder.php',
    'SmModuleSeeder' => $baseDir . '/database/seeds/SmModuleSeeder.php',
    'SmOnlineExamTableSeeder' => $baseDir . '/database/seeds/SmOnlineExamTableSeeder.php',
    'SmPostalDispatchTableSeeder' => $baseDir . '/database/seeds/SmPostalDispatchTableSeeder.php',
    'SmPostalReceiveTableSeeder' => $baseDir . '/database/seeds/SmPostalReceiveTableSeeder.php',
    'SmQuestionBanksTableSeeder' => $baseDir . '/database/seeds/SmQuestionBanksTableSeeder.php',
    'SmRole' => $baseDir . '/database/seeds/SmRole.php',
    'SmSchoolTableSeeder' => $baseDir . '/database/seeds/SmSchoolTableSeeder.php',
    'SmSessionsTableSeeder' => $baseDir . '/database/seeds/SmSessionsTableSeeder.php',
    'SmStaffsTableSeeder' => $baseDir . '/database/seeds/SmStaffsTableSeeder.php',
    'SmStudent' => $baseDir . '/database/seeds/SmStudent.php',
    'SmStudentCategoriesTableSeeder' => $baseDir . '/database/seeds/SmStudentCategoriesTableSeeder.php',
    'SmStudentGroupTableSeeder' => $baseDir . '/database/seeds/SmStudentGroupTableSeeder.php',
    'SmStudentHomeworkTableSeeder' => $baseDir . '/database/seeds/SmStudentHomeworkTableSeeder.php',
    'SmStudentsTableSeeder' => $baseDir . '/database/seeds/SmStudentsTableSeeder.php',
    'SmSubjectsSeeder' => $baseDir . '/database/seeds/SmSubjectsSeeder.php',
    'SmVisitorTableSeeder' => $baseDir . '/database/seeds/SmVisitorTableSeeder.php',
    'Sm_Class_seeder' => $baseDir . '/database/seeds/Sm_Class_seeder.php',
    'Sm_base_group_seeder' => $baseDir . '/database/seeds/Sm_base_group_seeder.php',
    'Sm_class_section_seeder' => $baseDir . '/database/seeds/Sm_class_section_seeder.php',
    'Sm_country_seeder' => $baseDir . '/database/seeds/Sm_country_seeder.php',
    'Sm_general_setting_seeder' => $baseDir . '/database/seeds/Sm_general_setting_seeder.php',
    'Sm_phone_call_logsSeeder' => $baseDir . '/database/seeds/Sm_phone_call_logsSeeder.php',
    'Sm_section_seeder' => $baseDir . '/database/seeds/Sm_section_seeder.php',
    'Sm_users_seeder' => $baseDir . '/database/seeds/Sm_users_seeder.php',
    ...
    'SmquestionGroupTableSeeder' => $baseDir . '/database/seeds/SmquestionGroupTableSeeder.php',
    'SmquestionLevelTableSeeder' => $baseDir . '/database/seeds/SmquestionLevelTableSeeder.php',
    'Soumen\\Agent\\Agent' => $vendorDir . '/soumen-dey/laravel-user-agent/src/Agent.php',
    'Soumen\\Agent\\AgentServiceProvider' => $vendorDir . '/soumen-dey/laravel-user-agent/src/AgentServiceProvider.php',
    'Soumen\\Agent\\Exceptions\\MethodDoesNotExistsException' => $vendorDir . '/soumen-dey/laravel-user-agent/src/Exceptions/MethodDoesNotExistsException.php',
    'Soumen\\Agent\\Facades\\Agent' => $vendorDir . '/soumen-dey/laravel-user-agent/src/Facades/Agent.php',
    'Soumen\\Agent\\Services\\Browser' => $vendorDir . '/soumen-dey/laravel-user-agent/src/Services/Browser.php',
    'Soumen\\Agent\\Services\\Device' => $vendorDir . '/soumen-dey/laravel-user-agent/src/Services/Device.php',
    'Soumen\\Agent\\Services\\Header' => $vendorDir . '/soumen-dey/laravel-user-agent/src/Services/Header.php',
    'Soumen\\Agent\\Services\\Platform' => $vendorDir . '/soumen-dey/laravel-user-agent/src/Services/Platform.php',
    'Soumen\\Agent\\Services\\Server' => $vendorDir . '/soumen-dey/laravel-user-agent/src/Services/Server.php',
    'Soumen\\Agent\\Services\\Service' => $vendorDir . '/soumen-dey/laravel-user-agent/src/Services/Service.php',
    'Soumen\\Agent\\Services\\UserAgent' => $vendorDir . '/soumen-dey/laravel-user-agent/src/Services/UserAgent.php',
    'Soumen\\Agent\\Traits\\HasRequestParameters' => $vendorDir . '/soumen-dey/laravel-user-agent/src/Traits/HasRequestParameters.php',
